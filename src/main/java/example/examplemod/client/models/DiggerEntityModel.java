package example.examplemod.client.models;
...
public class DiggerEntityModel extends EntityModel<DiggerEntity> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(examplemod.MODID, "digger_entity"), "main");

	private final ModelPart body;

	public DiggerEntityModel(ModelPart root) {
	...
	@Override
	public void setupAnim(DiggerEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {}
